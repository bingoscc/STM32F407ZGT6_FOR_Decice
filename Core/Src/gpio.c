...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOG, LED_Green_Pin|LED_Red_Pin|GPIO_PIN_5|GPIO_PIN_6
  ...
  /*Configure GPIO pins : PA0 PA3 PA6 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_3|GPIO_PIN_6;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_Green_Pin LED_Red_Pin PG5 PG6
                           PG7 PG8 */
